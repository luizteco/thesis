      ...
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {devices.map((device, index) => (
            ...
            >
              <div className=\"h-full bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:border-purple-400 relative flex flex-col hover:-translate-y-2\">
